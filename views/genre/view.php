...
<main class="container">
    ...
    <?php if (isset($genre->book_title)): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <h1 class="header-block-one error"><a href="<?php echo($html->createLink('genre', 'index')); ?>"
                                              title="Renvoie vers la page qui liste tous les genres">Il n'y a pas encore
                de livre dans le genre &nbsp;: <?php echo($genre->genre_name); ?></a></h1>
        <a class="btnVert" href="<?php echo($html->createLink('genre', 'index')); ?>"
           title="Renvoie vers la page qui liste tous les genres">Voir les autres genres</a>
    <?php endif; ?>
