<main class="container">
    ...
    <div class="functions">
        <a class="create-book_btn float_left" href="<?php echo($html->createLink('genre', 'admin_create_genre')); ?>"
    ...
    <table class="table-book">
        ...
        <?php foreach ($genres as $genre): ?>
            <tr>
                ...
                <td><a href="<?php echo($html->createLink('genre', 'admin_show_genre', ['id' => $genre->id])); ?>"
...
<defs>
	...
	l-3.9-3.9l12.9-12.9l1.9,1.9L106.3,112.1z M117.9,43.2l-9.7-9.7l7.7-7.7h5.2L117.9,43.2z"/>
                ...
                <td><a href="<?php echo($html->createLink('genre', 'admin_edit_genre', ['id' => $genre->id])); ?>"
