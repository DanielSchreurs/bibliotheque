<main class="container">
    ...
    ?>
    <form class="form-create" action="<?php echo($html->createLink('book', 'user_UpdateReserve',['id'=>$reserve->reserved_id])); ?>" method="post">
        ...
        <input class="form-create__simple-imput <?php echo(isset($error['to']) ? 'error' : ''); ?>"
               ...
               placeholder="aaaa-mm-jj"/>
        <div class="form-create__example-box">
            <p class="form-create__example-box__text">Ici vou devez insérer la date de fin. Vous pouvez réserver le livre maximum pour un mois</p>
        </div>
