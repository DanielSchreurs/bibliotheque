    ...
    <ul class="liste_livres">
        <?php foreach ($data['data'] as $book): ?>
            <li>
                ...
                </h3><img src="./img/books_covers/<?php echo($book->front_cover); ?>.jpg"
                          alt="première du <?php echo($book->title); ?>" width="180" height="270">
                ...
                <dl class="info_Livre clearfix">
                    ...
                    <dt>Année</dt>
                    <dd><a href="#"
                           title="Renvois vers une page qui reprend tous les livre de l'année <?php echo($book->datepub); ?>"><?php echo(date('Y',strtotime($book->datepub))); ?></a>
                    </dd>
                    <dt>Bibliothèque</dt>
                    <dd><a href="#"
