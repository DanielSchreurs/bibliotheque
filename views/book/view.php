    ...
    <article class="single_book">
        <h2>
            <a href="<?php echo($html->createLink('book', 'view', ['id' => $book->book_id])); ?>"
               title="Renvois vers une page avec uniquement le livres Anthologie de <?php echo($book->title); ?>"><?php echo($book->title); ?></a>
        </h2>
        ...
        <dl class="info_Livre clearfix">
            ...
            <dd><a href="<?php echo($html->createLink('author', 'view', ['id' => $book->author_id])); ?>"
                   title="Renvois vers une page qui reprend tous les livres de <?php echo($book->author_first_name . ' ' . $book->author_last_name); ?>"><?php echo($book->author_first_name . ' ' . $book->author_last_name); ?></a>
            </dd>
            <dt>Editeur</dt>
            ...
            <dd><a href="<?php echo($html->createLink('genre', 'view', ['id' => $book->genre_id])); ?>"
                   title="Renvois vers une page qui reprend tous les livres du genre <?php echo($book->genre_name); ?>"><?php echo($book->genre_name); ?></a>
            </dd>
            <dt>Année</dt>
            <dd><a href="<?php //echo($html->createLink('book','view',['id'=>$book->editor_id]));?>"
                   title="Renvois vers une page qui reprend tous les livres de l'année <?php echo($book->datepub); ?>"><?php echo(date('Y',
