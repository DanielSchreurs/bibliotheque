<main class="container">
    ...
    <div class="functions">
        <a class="create-book_btn float_left" href="<?php echo($html->createLink('author','admin_create_author',['step'=>1])); ?>"
    ...
    <table class="table-book">
        ...
        <?php foreach ($books as $book): ?>
            <tr>
                ...
                <td><?php echo($book->editor_name); ?></td>
                <td><?php echo($book->genre_name); ?></td>
                <td><?php echo($book->book_date); ?></td>
                <td><?php echo($html->cutText($book->summary, 20)); ?></td>
                <td><a href="<?php echo($html->createLink('book', 'admin_show_book', ['id' => $book->book_id])); ?>"
...
<defs>
	...
	l-3.9-3.9l12.9-12.9l1.9,1.9L106.3,112.1z M117.9,43.2l-9.7-9.7l7.7-7.7h5.2L117.9,43.2z"/>
                ...
                <td><a href="<?php echo($html->createLink('book', 'admin_edit_book', ['id' => $book->book_id])); ?>"
