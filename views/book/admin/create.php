    ...
    <form class="form-create large"
        ...
        <select class="form-create__select" name="author_id" id="author_id">
            <?php foreach ($authors as $author): ?>
                <option
                    <?php echo(isset($sent->author_id) && $sent->author_id == $sent->author_id ? 'selected' : ''); ?>
        ...
        <select class="form-create__select" name="language_id" id="language_id">
            <?php foreach ($langues as $langue): ?>
                <option
                    <?php echo(isset($sent->language_id) && $sent->language_id == $sent->language_id ? 'selected' : ''); ?>
        ...
        <select class="form-create__select" name="editor_id" id="editor_id">
            <?php foreach ($editors as $editor): ?>
                <option
                    <?php echo(isset($sent->editor_id) && $sent->editor_id == $sent->editor_id ? 'selected' : ''); ?>
        ...
        <select class="form-create__select" name="genre_id" id="genre_id">
            <?php foreach ($genres as $genre): ?>
                <option
                    <?php echo(isset($sent->editor_id) && $sent->editor_id == $sent->genre_id ? 'selected' : ''); ?>
        ...
        <label for="isbn">ISBN du livre<strong
                class="form-create--obligatoire">*</strong></label>
        <input class="form-create__simple-imput <?php echo(isset($errors['isbn'])? 'error' :''); ?>" type="text" name="isbn" id="isbn"
               title="Introduisez votre ISBN"
               value="<?php echo(isset($errors['isbn']) || $_GET ? '' : $sent->isbn); ?>"/>
        ...
        <label for="nbpages">Nombre de page<strong
                class="form-create--obligatoire">*</strong></label>
        <input class="form-create__simple-imput <?php echo(isset($errors['nbpages'])? 'error' :''); ?>" type="number" name="nbpages" id="nbpages"
               title="Introduisez le nombre de page du livre"
               value="<?php echo(isset($errors['nbpages']) || $_GET? '' : $sent->nbpages); ?>"/>
        ...
        <label for="datepub">Date de publication (jj/mm/aaaa)<strong
                class="form-create--obligatoire">*</strong></label>
        <input class="form-create__simple-imput <?php echo(isset($errors['datepub'])? 'error' :''); ?>" type="date" name="datepub" min="2" id="datepub"
