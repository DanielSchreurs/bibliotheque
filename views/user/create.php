        ...
        <form class="form-create" action="<?php $html->createLink('user', 'create'); ?>" method="post">
            ...
            <fieldset>
                ...
                <div class="form-create__example-box">
                    <p class="form-create__example-box__text">Pour des raisons de sécurités, celui-ci doit-être unique et peut donc générer une erreur s'il existe déjà.</p>
                </div>
                ...
                <div class="form-create__example-box">
                    <p class="form-create__example-box__text">Ici vous devez insérer votre adresse mail dans un format valide. Quelque chose comme ceci, <i>nom@domaine.com</i>.</p>
                </div>
