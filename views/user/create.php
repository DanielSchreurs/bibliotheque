<main>
    ...
    <?php $sent=$data['data']['sent']; var_dump($data); ?>
    <form class="form-create-user" action="<?php $html->createLink('user', 'create'); ?>" method="post">
        ...
        <fieldset>
            ...
            <input class="error" type="text" name="first_name" id="first_name" value="<?php echo(isset($sent->first_name)?$sent->first_name:''); ?> " placeholder="Jane"
        ...
        <fieldset>
            ...
            <input type="text" name="username" id="username" value="" title="Introduisez votre nom d’utilisateur"
                   placeholder="Janette"/>
            <label for="email">Votre adresse mail <strong class="form-create-user__obligatoire">*</strong></label>
            <input type="text" name="email" id="email" value="" title="Introduisez votre adressse mail"
            ...
            <input type="password" name="password" id="password" value="" title="Introduisez votre mot de pass"
        ...
        <fieldset>
            ...
            <input type="text" name="question" id="question" value="" title="Introduisez une question de sécurité"
                   placeholder="Quel est le nom de mon premier copain"/>
            <label for="answer">réponse à cette question</label>
            <input type="text" name="answer" id="answer" value="" title="Introduisez la réponse à la question"
                   placeholder="Mystère"/>
            <!-- <div class="form-create-user--error">
                 <p>Votre champ nom, prenom doivent être remplis.</p>
             </div>-->
