  ...
  <form class="form-create-user">
    ...
    <fieldset>
      ...
      <input type="email" name="email" id="email" value="" title="Introduisez votre adressse mail" placeholder="jane.doe@outlook.com"/>
        <span id="linkShowPassword" title="Afficher les mots de pass" class="smallInfo icon ouvrir">Montrer les mots de pass</span>
      ...
      <label for="password1">Votre Mot de passes <strong class="form-create-user__obligatoire">*</strong></label>
