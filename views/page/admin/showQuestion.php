...
<main class="single_book container">
    ...
    ?>
    <div class="functions">
        <a class="delete-book_btn" href="<?php echo($html->createLink('page', 'admin_deleteQuestion',['id' => $article->question_id])); ?>"
           title="Ajouter un livre">Supprimer  la question et sa réponse</a>
        <a class="edit-book_btn" href="<?php echo($html->createLink('page', 'admin_editQuestion', ['id' => $article->question_id])); ?>"
    ...
    <article class="question">
        ...
        <?php if ($article->answer === null): ?>
            <a href="<?php echo($html->createLink('page','user_createAnswer',['id'=>$article->question_id])); ?>" class="btnVert">Répondre à cette question</a>
        <?php else: ?>
