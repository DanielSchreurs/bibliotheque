...
<main class="single_book container">
    ...
    <div class="functions">
        <a class="delete-book_btn"
           href="<?php echo($html->createLink('author', 'admin_delete_author', ['id' => $author->author_id])); ?>"
           title="Ajouter un livre">Supprimer &laquo;&nbsp;<?php echo($author->first_name . '-' . $author->last_name); ?>
            &nbsp;&raquo;</a>
        <a class="edit-book_btn"
           href="<?php echo($html->createLink('author', 'admin_edit_author', ['id' => $author->author_id])); ?>"
           title="Ajouter un livre">Modifier &laquo;&nbsp;<?php echo($author->first_name . '-' . $author->last_name); ?>
            &nbsp;&raquo;</a>
    ...
    <h1 class="header-block-one ">Supprimer un
        auteur &laquo;&nbsp;<?php echo($author->first_name . '-' . $author->last_name); ?>&nbsp;&raquo;</h1>

    <div class="threeColumnBlock">
        <a href="#"><img
                src="./img/authors_photo/<?php echo($author->author_photo); ?>"
                alt="Portrait de  <?php echo($author->first_name . '-' . $author->last_name); ?>" width="300"
                height="450"></a>
